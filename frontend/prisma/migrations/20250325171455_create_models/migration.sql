...
-- CreateEnum
CREATE TYPE "DayOfWeek" AS ENUM ('MONDAY', 'TUESDAY', 'WEDNESDAY', 'THRUSDAY', 'FRIDAY', 'SATURDAY', 'SUNDAY');
...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'HyperGG Rides',
    "address" TEXT NOT NULL DEFAULT '89 Car Street, Autoville, GG 69420',
    "phone" TEXT NOT NULL DEFAULT '+91 (965) 741-2XXX',
    "email" TEXT NOT NULL DEFAULT 'contactquery@hypergg.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
