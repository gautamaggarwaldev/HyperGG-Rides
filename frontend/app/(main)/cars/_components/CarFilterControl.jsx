  ...
  const filterSections = [
    {
      ...
      title: "Make",
      options:
        filters?.makes?.map((make) => ({ value: make, label: make })) || [],
      currentValue: make,
    ...
    },
    {
      ...
      title: "Body Type",
      options:
        filters?.bodyTypes?.map((type) => ({ value: type, label: type })) || [],
    ...
    },
    {
      ...
      title: "Fuel Type",
      options:
        filters?.fuelTypes?.map((type) => ({ value: type, label: type })) || [],
