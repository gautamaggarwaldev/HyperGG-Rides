          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-500">
                Thousands of verified vehicles from trusted <br /> dealerships
                and private sellers.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-500">
                Book a test drive online in minutes, with flexible <br />{" "}
                scheduling options.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-500">
                Verified listings and secure booking process for <br /> peace of
                mind.
              </p>
            </div>
          </div>
